...
<div class="container mt-3">
    <div class="row">
        <div class="col-lg-7 mx-auto">
            <div class="header">
                <span class="header-title">MICROBLOG</span>&nbsp;<span class="header-subtitle">lorem, ipsum dolor sit amet consectetur.</span>
            </div>
            ...
            <div class="footer">
                ...
                <div class="row">
                    <div class="col-6">
                        &copy; 2021 Microblog. All right reserved.
                        Made with love for IND
                    </div>
                    <div class="col-6">
                        <ul>
                            <li>
                                <a href="javascript:;" class="social-links">
